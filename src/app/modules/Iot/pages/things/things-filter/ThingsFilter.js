...
export function ThingsFilter({ listLoading }) {
  // Things UI Context
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(thingsUIProps.queryParams, values);
    if (!isEqual(newQueryParams, thingsUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      thingsUIProps.setQueryParams(newQueryParams);
    }
  };
