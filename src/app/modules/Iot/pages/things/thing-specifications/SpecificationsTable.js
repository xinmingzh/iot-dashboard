...
export function SpecificationsTable() {
  ...
  const specsUIProps = useMemo(() => {
    return {
      ...
      thingId: specsUIContext.thingId,
    };
  }, [specsUIContext]);
  ...
  useEffect(() => {
    specsUIProps.setIds([]);
    dispatch(
      actions.fetchSpecifications(specsUIProps.queryParams,specsUIProps.thingId)
    );
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [specsUIProps.queryParams, dispatch, specsUIProps.thingId]);
